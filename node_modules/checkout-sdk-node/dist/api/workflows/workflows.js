...
class Workflows {
  ...
  updateAction(workflowId, workflowActionId, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.put)(_this6.config.httpClient, `${_this6.config.host}/workflows/${workflowId}/actions/${workflowActionId}`, _this6.config, _this6.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  updateCondition(workflowId, workflowConditionId, body) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.put)(_this7.config.httpClient, `${_this7.config.host}/workflows/${workflowId}/conditions/${workflowConditionId}`, _this7.config, _this7.config.sk, body);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getEventTypes() {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this8.config.httpClient, `${_this8.config.host}/workflows/event-types`, _this8.config, _this8.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getEvent(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this9.config.httpClient, `${_this9.config.host}/workflows/events/${id}`, _this9.config, _this9.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  getActionInvocations(eventId, workflowActionId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this10.config.httpClient, `${_this10.config.host}/workflows/events/${eventId}/actions/${workflowActionId}`, _this10.config, _this10.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  reflowByEvent(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this11.config.httpClient, `${_this11.config.host}/workflows/events/${id}/reflow`, _this11.config, _this11.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  reflowByEventAndWorkflow(eventId, workflowId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this12.config.httpClient, `${_this12.config.host}/workflows/events/${eventId}/workflow/${workflowId}/reflow`, _this12.config, _this12.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  reflowEventsByEventAndWorkflowIds(events, workflows) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this13.config.httpClient, `${_this13.config.host}/workflows/events/reflow`, _this13.config, _this13.config.sk, {
          events,
          workflows
        });
        return yield response.json;
  ...
  reflowEventsBySubjectAndWorkflowIds(subjects, workflows) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this14.config.httpClient, `${_this14.config.host}/workflows/events/reflow`, _this14.config, _this14.config.sk, {
          subjects,
          workflows
        });
        return yield response.json;
  ...
  getSubjectEvents(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.get)(_this15.config.httpClient, `${_this15.config.host}/workflows/events/subject/${id}`, _this15.config, _this15.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  reflowBySubject(id) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this16.config.httpClient, `${_this16.config.host}/workflows/events/subject/${id}/reflow`, _this16.config, _this16.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
  ...
  reflowBySubjectAndWorkflow(subjectId, workflowId) {
    ...
    return _asyncToGenerator(function* () {
      try {
        const response = yield (0, _http.post)(_this17.config.httpClient, `${_this17.config.host}/workflows/events/subject/${subjectId}/workflow/${workflowId}/reflow`, _this17.config, _this17.config.sk);
        return yield response.json;
      } catch (err) {
        const error = yield (0, _errors.determineError)(err);
        throw error;
